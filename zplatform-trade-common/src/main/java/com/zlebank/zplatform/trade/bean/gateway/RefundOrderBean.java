...
public class RefundOrderBean implements Serializable{
	 ...
	 * serialVersionUID
	 */
	private static final long serialVersionUID = -333510552332203624L;
	...
	private String origOrderId;// 原始交易订单号--tn
	@Length(max = 2, message = "param.error.refundType")
