...
public class CreditConsumeAccounting implements IAccounting {
	...
	public ResultBean accountedFor(String txnseqno) {
		log.info("交易:"+txnseqno+"授信账户消费处理开始");
       ...
       tradeInfo.setAccess_coopInstCode(txnsLog.getAccfirmerno());
        ...
        if("0000".equals(retCode)){
        	 txnsLog.setApporderinfo("授信账户消费成功");
        ...
        log.info("交易:"+txnseqno+"授信账户消费处理成功");
		return resultBean;
	}
