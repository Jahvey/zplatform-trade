...
public class CreditRechargeAccounting implements IAccounting{
    ...
    public CreditRechargeAccounting(){
	...
	public ResultBean accountedFor(String txnseqno) {
		log.info("交易:"+txnseqno+"授信账户充值处理开始");
        ...
        /**收款方会员ID**/
        String payToMemberId = txnsLog.getAccfirmerno();
        /**收款方父级会员ID**/
       ...
       tradeInfo.setAccess_coopInstCode(txnsLog.getAccfirmerno());
        ...
        if("0000".equals(retCode)){
        	 txnsLog.setApporderinfo("授信账户充值成功");
        ...
        log.info("交易:"+txnseqno+"授信账户充值处理成功");
		return resultBean;
	}
